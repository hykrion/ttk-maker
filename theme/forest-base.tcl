...
# The forest theme is a beautiful modern ttk theme inspired by Microsoft's fluent design.
package provide ttk::theme::forest 1.0
...
namespace eval ttk::theme::forest {
  ...
  proc get_colors {} {
    ...
    foreach {opt val} [array get colors] {
  ...
  proc Create {} {
    ...
    ttk::style theme create forest -parent clam -settings {
